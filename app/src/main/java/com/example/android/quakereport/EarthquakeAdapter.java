...
//   The result will be a String containing the characters PRIOR to the “ of ” text and a String containing the characters AFTER the “ of “ text.
    ...
    // Get the magnitude color according to magnitude of earthquake
    private int getMagnitudeColor(double magnitude) {
        int magnitudeColorResourceId;
        int magnitudeFloor = (int) Math.floor(magnitude);
        // Switch statement cannot accept a double value, that's why convert the decimal magnitude value into an integer
        switch (magnitudeFloor) {
            // Set the value of the magnitudeColorResourceId variable to be one of the color resources that we defined the colors.xml file
            case 0:
            case 1:
        ...
        // Cnnvert the color resource ID into an actual integer color value
        // Color resource IDs just point to the location of the resource, but not the value of the color.
